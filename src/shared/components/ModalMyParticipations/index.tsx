...
import { CardDetailedMyHoldings } from '@/shared/components/CardDetailedMyHoldings';
...
export const ModalMyParticipations = ({ isOpen, onChange }: ModalProps) => {
  return (
